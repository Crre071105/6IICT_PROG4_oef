...
label_3 = tk.Label(master=venster, text= "(2,0) - rowspan=2")
label_4 = tk.Label(master=venster, text="(0,1)")
label_5 = tk.Label(master=venster, text= "(1,1) - columnspan = 2")
label_6 = tk.Label(master=venster, text= "(2,1)")
label_7 = tk.Label(master=venster, text="(3,1)")
label_8 = tk.Label(master=venster, text= "(0,2)")
label_9 = tk.Label(master=venster, text= "(2,2")
label_10 = tk.Label(master=venster, text="(3,2)")
label_1.grid(row=0, column=0)
label_2.grid(row=1, column=0)
label_3.grid(row=2, column=0,rowspan=2)

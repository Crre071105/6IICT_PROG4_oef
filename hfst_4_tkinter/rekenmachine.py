...
knop0_ingedrukt = partial(knop_ingedrukt, 0)
knop_0 = tk.Button(master=venster, width=40, command=knop0_ingedrukt , text="0")
knop_0.grid(row=4, column=0, padx=2, pady=2, columnspan=2)
venster.mainloop()
